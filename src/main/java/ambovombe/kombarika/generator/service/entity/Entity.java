                ...
                for (Map.Entry<String, String> set : columns.entrySet()) {
                        ...
                        if (temp != null) {
                                res += "\t"
                                                + this.getLanguageProperties().getAnnotationSyntax().replace("?",
                                                                this.getAnnotationProperty().getConstraints()
                                                                                .getForeignKey().getAnnotation()
                                                                                .replace("?", set.getKey()))
                                                + "\n";
                                if (!this.getAnnotationProperty().getConstraints().getForeignKey().getManyToOne()
                                                .equals("")) {
                                        res += "\t"
                                                        + this.getLanguageProperties().getAnnotationSyntax().replace(
                                                                        "?",
                                ...
                                res += "\t"
                                                + this.getLanguageProperties().getFieldSyntax()
                                                                .replace("Type", typeMapping.getListMapping()
                                                                                .get(set.getValue()).getType())
                                                                .replace("field",
        ...
        public String getEncapsulation(HashMap<String, String> columns, HashMap<String, String> foreignKeys) {
                ...
                for (Map.Entry<String, String> set : columns.entrySet()) {
                        ...
                        rep += this.getLanguageProperties().getEncapsulation()
                                        ...
                                        .replace("#Field#",
                                                        ObjectUtility.formatToCamelCase(
                                                                        ObjectUtility.capitalize(set.getKey())))
                                        .replace("#field#", ObjectUtility.formatToCamelCase(set.getKey()));
                }
                return rep;
        }
