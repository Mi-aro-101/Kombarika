...
public enum DatabaseType {
    ...
    private DatabaseType(String name, String driver, String sequence, String createConfigQuery, String queryTable,
            String queryCheckViews, String queryColumn, String queryConstraint, String[] valuequeryConstraint,
            String foreignKeyQuery, String[] valueforeignKeyQuery, String primaryKeyQuery) {
        this.setName(name);
